...
% TODO: write introduction into background and related work chapter

\section{Technical Background}
% TODO: put some more technical background points
...
% TODO: Put some more thesises used for example for feature extraction here
...
\begin{figure}[htbp]
  ...
  \caption{FastAPI documentation of classificationo API}
  \label{fig:fastapi_docs}
\end{figure}
\FloatBarrier

% TODO: hier noch kurz eine api implementieren -> tracking id als input und klasse ausgeben
