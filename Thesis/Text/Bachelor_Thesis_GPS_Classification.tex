...
\begin{acronym}[GPS]
  ...
  \acro{DBSCAN}{Density-Based Algorithm for Discovering Clusters in Large
    Spatial Databases with Noise}
\end{acronym}

\chapter{Introduction}

% TODO: REWRITE, since i didnt implement the osm parameter calulation
...
In this work, a combination of geometric (e.g., bounding box area, point
...
This work addresses this gap by proposing a pipeline to distinguish between
