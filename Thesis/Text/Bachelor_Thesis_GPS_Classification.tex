...
\begin{enumerate}
  ...
  \item \textbf{Duration:} Total time spent for the trackings, captured in
...
\begin{itemize}
  \item \textbf{id\_tracking:}
  \item \textbf{sequence:}
  \item \textbf{latitude:}
  \item \textbf{longitude:}
  \item \textbf{speed:}
  \item \textbf{tracking\_duration:}
  \item \textbf{tracking\_length:}
\end{itemize}
...
The filters were included directly in the SQL query during the data loading, to
reduce the amount of data stored and reduce computation time of further steps.
