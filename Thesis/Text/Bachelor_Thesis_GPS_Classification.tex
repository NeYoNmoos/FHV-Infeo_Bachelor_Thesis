...
wastecollection vehicles from various waste collection businesses and provided
...
\begin{itemize}
  ...
  \item Collection point are more spaced out, and routes often span small
...
seperattion between the extremese \texttt{URBAN} and \texttt{RURAL}, especially
...
\texttt{num\_points} exists, as these features all describe the scale of the
tracking.
\texttt{point\_density} shows a strong negative correlation with those same
features, indicating that shorter, more cmpact routes have denser GPS point
coverage.
...
information about the geometric of the tracking.
...
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.8\textwidth]{AI_Sheet_quer.pdf}
